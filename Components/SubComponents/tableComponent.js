...
function tableComponent(props) {
  ...
  <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"/>
               ...
               }} style={{borderRadius : "0.5rem",backgroundColor : "darkgrey" ,  color : "black"}}  class=" p-2">  <UShipperModal shipper={el} change_var={props.change_var} change_function={props.change_function} /> </button></td> )  : (null)}
               
              {props.defaultButton ? (<td><div style={{width : "10rem" }} className="text-center">{props.modalComponent}</div></td>) : (<td><VModalShipper tablename={props.tablename} data={el}  icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-binoculars" viewBox="0 0 16 16">
